...
import com.reactnativecomponent.barcode.decoding.zxing.DecodeFormatManager;
 ...
 */
final public class QmDecodeThread extends Thread {

  public static final String BARCODE_BITMAP = "barcode_bitmap";

  private final CaptureView captureView;
  private final Hashtable<DecodeHintType, Object> hints;
  private QmDecodeHandler handler;
  private final CountDownLatch handlerInitLatch;//到计数的锁
  public boolean flag=true;

  public QmDecodeThread(CaptureView captureView,
...
//    }
  ...
  public void run() {
    ...
    Looper.prepare();
      handler = new QmDecodeHandler(captureView, hints);
